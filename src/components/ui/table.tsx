...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-8 px-3 text-left align-middle font-semibold text-slate-600 has-[[role=checkbox]]:pr-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("p-2.5 align-middle has-[[role=checkbox]]:pr-0 text-slate-800", className)}
    {...props}
  />
));
